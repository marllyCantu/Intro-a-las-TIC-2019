						...
						<form action="#">
							<div class="row">
								<div class="col-md-6">
									<fieldset>
										...
										<div class="form-group row">
											<label class="col-lg-3 col-form-label">Generación:</label>
											<div class="col-lg-9">
												<input type="text" class="form-control" placeholder="2019-2022">
											</div>
										</div>
								...
								<div class="col-md-6">
									<fieldset>
					                	<legend class="font-weight-semibold"><i class="icon-truck mr-2"></i> Detalles</legend>

										<div class="form-group row">
											<label class="col-lg-3 col-form-label">Cantidad de alumnos</label>
											<div class="col-lg-9">
												<div class="row">
													<div class="col-md-6">
										...
										<div class="form-group row">
											...
											<div class="col-lg-9">
												<input type="tel" placeholder="834 267 4576" class="form-control">
											</div>
										</div>-->
										...
										<!--<div class="form-group row">
											...
											<div class="col-lg-9">
												<div class="row">
													...
													<div class="col-md-6">
														<input type="text" placeholder="Ciudad" class="form-control mb-3">
										...
										<div class="form-group row">
											<label class="col-lg-3 col-form-label">Hora de entrada:</label>
											<div class="col-lg-9">
												<input type="text" placeholder="7:00 am" class="form-control">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-lg-3 col-form-label">Hora de descanso:</label>
											<div class="col-lg-9">
												<input type="text" placeholder="10:00 - 10:30 am" class="form-control">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-lg-3 col-form-label">Hora de salida:</label>
											<div class="col-lg-9">
												<input type="text" placeholder="2:00 pm" class="form-control">
											</div>
										</div>

										<div class="form-group row">
											<label class="col-lg-3 col-form-label">Materias:</label>
											<div class="col-lg-9">
						    ...
						    <form action="#">
						        <div class="row">
							       <div class="col-md-6">
									     <fieldset>
										   <legend class="font-weight-semibold"><i class="icon-reading mr-2"></i> Turor:</legend> 

										   <div class="form-group row">
											<label class="col-lg-3 col-form-label">Nombre:</label>
											<div class="col-lg-9">
												<input type="text" class="form-control" placeholder="Arturo Almazán">
											</div>
										    </div>
