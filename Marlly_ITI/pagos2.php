					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Form layouts">
								<li class="nav-item"><a href="prueba2.php" class="nav-link">Registrar alumnos</a></li>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Formularios</span> - Ruta</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<span class="breadcrumb-item active">Registrar ruta</span>
						</div>
							...
							<div class="card-body">
								<form action="#">
									<!--<div class="form-group row">
										<label class="col-lg-3 col-form-label">Número de autobús:</label>
										<div class="col-lg-9">
									...
									<div class="form-group row">
										...
										<div class="col-lg-9" >
											<select class="form-control form-control-select2" data-fouc>
												<optgroup label="" >
													<option value="uno">Tamatán</option>
													<option value="dos">Libertad</option>
												</optgroup>
											</select>
										</div>
									</div>
									<div class="form-group row">
										...
										<div class="col-lg-9" >
											<select class="form-control form-control-select2" data-fouc>
												<optgroup label="" >
													<option value="uno">Mañana 6:00 am</option>
													<option value="dos">Noche 9:00 pm</option>
													<option value="tres">Ambos</option>
												</optgroup>
											</select>
										</div>
									</div>
									<div class="form-group row">
										...
										<div class="col-lg-9">
											<input type="Email" class="form-control" placeholder="Isaac Martínez">
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-lg-9">
											<input type="text" class="form-control" placeholder="ejemplo@upv.edu.mx">
										</div>
									</div>
									<div class="form-group row">
									...
									<!--<div class="form-group row">
										...
										<div class="col-lg-9">
											<input type="multiple" class="form-control" placeholder="Ingeniería en tecnologías de la información">
										</div>
									</div>-->
									<div class="form-group row">
									...
									<div class="form-group row">
										...
										<div class="col-lg-9">
											<input type="tel" class="form-control" placeholder="834 213 3212">
										</div>
									</div>
									...
									<!--<div class="form-group row">
										...
										<div class="col-lg-9">
											...
											<span class="form-text text-muted">Formatos aceptados: gif, png, jpg. Tamaño máximo 2Mb</span>
										</div>
									</div>

									<div class="form-group row">
										<label class="col-lg-3 col-form-label">Páginas:</label>
										<div class="col-lg-9">
