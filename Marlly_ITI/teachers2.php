			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Formularios</span> - Maestros</h4>
					...
					<div class="card-body">
						<form action="#">
							<div class="row">
								<div class="col-md-6">
									<fieldset>
										...
										<div class="form-group row">
											...
											<div class="col-lg-9">
												<input type="text" class="form-control" placeholder="Normando">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-lg-3 col-form-label">Contraseña:</label>
											<div class="col-lg-9">
												<input type="text" class="form-control" placeholder="Rodríguez">
											</div>
										</div>
										...
										<!--<div class="form-group row">
											<label class="col-lg-3 col-form-label">Ingresa tu foto:</label>
											<div class="col-lg-9">
												<input type="file" class="form-input-styled" placeholder="Escoge un archivo"data-fouc>
											</div>
										</div>-->
								...
								<div class="col-md-6">
									<fieldset>
					                	<legend class="font-weight-semibold"><i class="icon-truck mr-2"></i> Información personal</legend>
										...
										<div class="form-group row">
											...
											<div class="col-lg-9">
												<div class="row">
													<div class="col-md-6">
														<input type="text" placeholder="HRSG4536254GFT" class="form-control">
													</div>
