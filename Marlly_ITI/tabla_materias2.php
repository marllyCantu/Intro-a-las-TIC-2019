		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Formularios</span> - Materias</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<span class="breadcrumb-item active">Editar Materias</span>
						</div>
			...
			<div class="content">
							...
							<form action="#" class="form-horizontal">
								<div class="modal-body">
									...
									<div class="form-group row">
										...
										<div class="col-sm-9">
											<input type="text" placeholder="43567" class="form-control">
										</div>
									</div>

									<div class="form-group row">
										<label class="col-form-label col-sm-3">Horas por semana:</label>
										<div class="col-sm-9">
											<input type="number" placeholder="3" class="form-control">
										</div>
									</div>

									<div class="form-group row">
										<label class="col-form-label col-sm-3">Cantidad de grupos:</label>
										<div class="col-sm-9">
									...
									<div class="form-group row">
											<label class="col-lg-3 col-form-label">Área:</label>
											<div class="col-lg-9">
												<select data-placeholder="Selecciona el grupo" class="form-control form-control-select2" data-fouc>
													<option></option>
													...
													<optgroup label="Licenciaturas">
														<option value="LAYGE">Licenciatura y Administración de Pequeñas y Medianas Empresas</option>
													</optgroup>
													<optgroup label="Maestrías">
														<option value="MI">Maestría en Ingeniería</option>
														<option value="MER">Maestría en Energías Renovables</option>
										...
										<div class="form-group row">
											...
											<div class="col-lg-9">
												<select data-placeholder="Selecciona el cuatrimestre" class="form-control form-control-select2" data-fouc>
													<option></option>
													<optgroup label="Carreras">
														...
														<option value="cinco">Quinto</option>
														<option value="seis">Sexto</option>
														<option value="siete">Séptimo</option>
														<option value="ocho">Octavo</option>
														<option value="nueve">Noveno</option>
														<option value="diez">Décimo</option>
													</optgroup>
													<optgroup label="Maestrías">
														<option value="uno">Primero</option>
														<option value="dos">Segundo</option>
				...
				<div class="row">
					<div class="col-md-6">
						...
						<tbody>
							<tr>
								...
								<td>5</td>
								<td>2</td>
								<td>Ingeniería en Tecnologías de la Inofrmación</td>
							    <td>Primero</td>
							    <td>Eréndira Rodríguez</td>
							...
							<tr>
								<td>Introducción a las Tecnologías de la Información</td>
								<td>27097</td>
								<td>4</td>
								<td>3</td>
					...
					<div class="modal-dialog modal-lg">
						<div class="modal-content">
						<div class="modal-header"><h5 class="modal-title">Eliminar materia</h5><button type="button" class="bootbox-close-button close" data-dismiss="modal" aria-hidden="true">×</button>
						</div>
						<div class="modal-body"><div class="bootbox-body">
							<div class="row"> 
							 <div class="col-md-12">
							 	...
							 	<div class="form-group row"><label class="col-md-4 col-form-label">¿Estás seguro de querer eliminar la materia?</label>
							 		<div class="col-md-8">
