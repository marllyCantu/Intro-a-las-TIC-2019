				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<span class="breadcrumb-item active">Editar Maestros</span>
						</div>
						...
						<div class="modal-content">
							...
							<form action="#" class="form-horizontal">
								<div class="modal-body">
									...
									<div class="form-group row">
										<label class="col-form-label col-sm-3">Especialización</label>
										<div class="col-sm-9">
											<input type="text" placeholder="Certificado en ..." class="form-control">
										</div>
									</div>
				...
				<div class="row">
					<div class="col-md-6">
						...
						<tbody>
							<tr>
								<td>Normando</td>
								<td><!--<a href="#">-->Rodríguez</td>
								<td>193062</td>
								<td>nrodc@cbtis236.edu.mx</td>
							...
							<tr>
								...
								<td>Contreras</td>								
								<td>1930069</td>
								<td>jsudgso@upv.edu.mx</td>
								<td>Ingeniero en Mecatrónica</td>
								<td>8342136508</td>
							...
							<tr>
								...
								<td>Smith</td>
								<td>1930012</td>
								<td>raerae@hotmail.com</td>
								<td>Ingeniero en Manufactura</td>
								<td>8345434326</td>
